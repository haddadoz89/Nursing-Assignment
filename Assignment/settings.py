...
ALLOWED_HOSTS = ['127.0.0.1', 'nursing-assignment.onrender.com']
...
DATABASES = {
    'default': dj_database_url.config(
        # This reads the database URL from a secure environment variable
...
AUTHENTICATION_BACKENDS = [
    'main_app.backends.PhoneOrUsernameBackend', # Your custom backend
...
LOGOUT_REDIRECT_URL = 'main_app:login'
